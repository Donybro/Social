...
let initialState = {
   currentDialogs:[
      ...
      {id:11,msgDirection:"from__me",text:"51111"},
      {id:12,msgDirection:"to__me",  text:"611111"},
      {id:13,msgDirection:"from__me",text:"71111"},
      {id:14,msgDirection:"to__me",  text:"811111"},
],
   dialogsBlock:[
